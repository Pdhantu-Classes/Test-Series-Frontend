          ...
          !loading ?
            <div className="row">
                ...
                <div className="text-center">
                  ...
                  <div className="profile-image-container" onChange={handleImage}>
                    <label htmlFor="file-input">
                      {
                        !imageUrl ?
                          <div className="btn btn-secondary mt-2">Upload Image</div>
                          :
                          <div className="btn btn-info mt-2">Change Image</div>
                      }
              ...
              <div className="col-md-9 personal-info">
                ...
                <div className="form-group">
                  <label className="col-lg-3 control-label">Choose Test Series</label>
                  <div className="col-lg-8">
                    {
                      !course ?
                        <select className="form-control" onChange={handleCourse} value={courses}>
                          <option defaultValue>Select Test Series</option>
                          <option value="1">CGPSC Prelims Test Series</option>
                          <option value="2">Chhattisgarh General Knowledge Test Series</option>
                          <option value="3">CGPSC Prelims+Chhattisgarh GK Test Series</option>
                        </select>
                        :
                        <select className="form-control" value={course} disabled>
                            {
                                course === 1 ?
                                    <option value={course.toString} >CGPSC Prelims Test Series</option>
                                :
                                course === 2 ?
                                    <option value={course.toString}>Chhattisgarh General Knowledge Test Series</option>  
                                :
                                    <option value={course.toString}>CGPSC Prelims+Chhattisgarh GK Test Series</option>                         
