                                            ...
                                            <div className="row text-center">
                                                ...
                                                >
                                                    <div className="card bg-info ">
                                                        <div className="card-body py-5 " style={{ height: "35vh" }}>
                                                            <div className="py-2 text-white" style={{fontSize:"45px"}}>CGPSC Prelims Test Series</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div
                                                ...
                                                >
                                                    <div className="card bg-primary ">
                                                        <div className="card-body py-5 " style={{ height: "35vh" }}>
                                                            <div className="py-4 text-white" style={{fontSize:"45px"}}>Current Affairs</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="offset-lg-3 offset-sm-0 offset-xs-0 mt-5 pt-5 container">
                                                <div className="row text-center">
                                                    ...
                                                    >
                                                        <div className="card bg-info ">
                                                            <div className="card-body py-5 " style={{ height: "35vh" }}>
                                                                <div className="py-2 text-white" style={{fontSize:"45px"}}>Chhattisgarh GK Test Series </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div
