  ...
  const signUpForm = () => (
    <div style={{marginTop:"100px"}}>
      ...
      <form>
        ...
        {
          !loading && message ?
            <div className="text-center"><span className="text-info"> New account is created. Please </span> <Link className="text-primary" to="/loginTestseries">Login</Link></div>
            :
            null
        }
        {
    ...
    <div>
      <div className="signup-form" style={{ marginTop: "-90px" }}>
        ...
        <div className="text-center">
          ...
          <Link to="/loginTestseries" className="text-danger">
            Login here
          </Link>
        </div>
      </div>
