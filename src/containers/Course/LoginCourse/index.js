...
const Login = () => {
    ...
    const SignInForm = () => (
        <div>
            <div className='h5 text-center text-danger'> Please Login for Course here</div>
            <form>
    ...
    return (
        <div>
            <div className="login-form" style={{ marginTop: "150px" }}>
                ...
                {SignInForm()}
                {redirectUser()}
                <p className="text-center"><Link to="/SignupCourse">Create an Account</Link></p>
                <p className="text-center text-danger"><Link to="/forgotPasswordCourse">Forgot Password</Link></p>
            </div>
        </div>
    );
