...
const GET_RANK_LIST = API_ENDPOINTS.USERS.GET_RANK_LIST
...
export default function AdminClassTestRankList() {
    ...
    useEffect(() => {
        setLoading(true);
        const TEST_PAPER_ID = window.localStorage.getItem("testPaperId");
        http
            .get(GET_RANK_LIST, {
                headers: {
