    ...
    return (
      ...
      <div className="ml-5 mt-4">
        <ul>
          ...
          <li>
          <div>For each incorrect answer there will be negative marking of 1/3 in this examination.</div>
          <div> कुल अंक = 200. प्रत्येक सही उत्तर के लिए उम्मीदवारों को दो अंक मिलेंगे।</div>
          </li>
